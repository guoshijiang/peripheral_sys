...
#include "../src/browser/urllineedit.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UrlLineEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UrlLineEdit_t qt_meta_stringdata_UrlLineEdit = {
    {
QT_MOC_LITERAL(0, 0, 11) // "UrlLineEdit"
...
const QMetaObject UrlLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_UrlLineEdit.data,
      qt_meta_data_UrlLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UrlLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UrlLineEdit.stringdata0))

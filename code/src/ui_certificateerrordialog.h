...
public:
    ...
    {
        CertificateErrorDialog->setWindowTitle(QApplication::translate("CertificateErrorDialog", "Dialog", Q_NULLPTR));
        m_iconLabel->setText(QApplication::translate("CertificateErrorDialog", "Icon", Q_NULLPTR));
        m_errorLabel->setText(QApplication::translate("CertificateErrorDialog", "Error", Q_NULLPTR));
...
"\n"
"Do you wish to override the security check and continue ?   ", Q_NULLPTR));
    } // retranslateUi
